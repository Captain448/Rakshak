  ...
  return (
    <div className="flex justify-center items-center py-16">
      <div className="w-full max-w-md bg-white border border-govgray-200 rounded p-6 shadow-md">
        ...
        <div className="flex flex-col gap-2 mt-4 text-center text-[10px] text-govgray-600 font-semibold">
          <p>
            Don&apos;t have an account?{" "}
            <Link href="/signup" className="text-saffron-600 hover:underline">
              Register here
            </Link>
          </p>
          <p>
            <Link href="/forgot-password" className="text-govgray-500 hover:underline">
              Forgot password?
            </Link>
          </p>
        </div>
